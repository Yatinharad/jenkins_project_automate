                    ...
                    <ul class="features-items">
                        <li class="feature-item">
                            ...
                            <div class="right-content">
                                <h4>To get in Shape !</h4>
                                <p>Get in shape and have fun with our diverse fitness programs designed to help you achieve your health goals while staying motivated!</p>                        </div>
                        </li>
                        <li class="feature-item">
                            <div class="left-icon">
                            ...
                            <div class="right-content">
                                ...
                                <p>Experience the joy of fitness and well-being with our engaging activities that make working out fun and enjoyable!</p>
                ...
                <div class="col-lg-6">
                    <ul class="features-items">
                        <li class="feature-item">
                            ...
                            <div class="right-content">
                                <h4>Earn Qualifications</h4>
                                <p>Enhance your employability by earning recognized qualifications through our fitness programs designed to help you achieve your goals and gain valuable skills</p>
                        ...
                        <div class="left-icon">
                            ...
                            <div class="right-content">
                                <h4>Develop New Skills</h4>
                                <p>Enhance your skills and knowledge through our fitness programs that provide valuable certifications and training opportunities to help you grow professionally & personally.</p>                            </div>
                        </li>
                        <li class="feature-item">
            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    <div class="cta-content">
                        ...
                        <p>Don't wait for the perfect moment - start your fitness journey today! Every step you take, no matter how small, brings you closer to a healthier, happier you. Our supportive community is here to motivate and guide you every step of the way. So, what are you waiting for? Take that first leap and begin your transformation today!
                        </p>
                        <div class="main-button scroll-to-section">
    ...
    <section class="section" id="our-classes">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="section-heading">
                       ...
                       <p>Explore our diverse range of fitness classes designed to challenge your body and energize your mind! From high-intensity interval training to restorative yoga, we offer something for every fitness level and preference.</p>
                     </div>
                </div>
            </div>
            <div class="row" id="tabs">
              <div class="col-lg-4">
                <ul>
                  <li><a href='#tabs-1'><img src="assets/images/tabs-first-icon.png" alt="">Strength Training</a></li>
            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="section-heading">
                        ...
                        <img src="assets/images/line-dec.png" alt="">
                        <p>Meet our dedicated trainers who are passionate about helping you achieve your fitness goals! Each trainer brings a wealth of experience and expertise in various disciplines, ensuring personalized guidance tailored to your needs. Join our community and let our trainers inspire and motivate you on your journey to better health and wellness!
                        </p> </div>
                </div>
            </div>
            <div class="row">
